...
object Main {
  ...
  // TODO:
  // Find the earliest year  each artist was actively releasing records 

  // TODO:
  // Enhance your previous answer to select the earliest and latest years

  // TODO:
  // Add type declarations to:
  // - numberOfAlbumsByArtist
  // - highestAlbumRatingByArtist
